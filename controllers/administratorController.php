			...
			<td>
			  <div class="btn-group">
			    ...
			    <ul class="dropdown-menu" role="menu">
			      <li><a href="#" onclick="ModalUpdate('<?php echo $data->user_ID; ?>','<?php echo $data->user_username; ?>','<?php echo $data->user_password; ?>','<?php echo $data->user_rol; ?> ');">Actualizar</a></li>
			      <li><a href="#" onclick="deleteUser('<?php echo $data->user_ID; ?>');">Borrar</a></li>
			    </ul>
			  </div>
			</td>
		</tr>
